...
class page_network_device extends Page {
    ...
    function init() {
        ...
        $bridge_tab->add('CRUD')->setModel($bridge_model,['address','fBasic_assetId','fBasic_latitude','fBasic_longitude','fBasic_hwType','fBasic_serial','fBasic_hwVersion','fBasic_swType','fBasic_swVersion','fTalqBridge_cmsUri','fTalqBridge_bootstrapComplete','fTalqBridge_pollTimeout','fTalqBridge_crlUrn','fTalqBridge_vendor','fTalqBridge_lastNotificationSeq']);
        $lamp_crud = $lamp_tab->add('CRUD');
        $lamp_crud->setModel($lamp_model,['address','bridge_id','fLampActuator_lampTypeId_id','fLampActuator_defaultLightState','fLampActuator_calendarID_id','fLampActuator_calendarID','fLampActuator_targetLightCommand','fLampActuator_feedbackLightCommand','fLampActuator_actualLightState']);
